...
vars_filter='.spec.serverless.edge_gateway.defaults | {PRIMARY_UPSTREAM: .primary_upstream, FALLBACK_UPSTREAM: .fallback_upstream, JWT_ISSUER: .jwt_issuer, TIMEOUT_MS: .timeout_ms}'
